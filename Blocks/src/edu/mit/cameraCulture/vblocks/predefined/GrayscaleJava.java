...
public class GrayscaleJava extends Module {
	...
	public ExecutionCode execute(Sample image) {
		...
		//	imageData[o] = 0xff000000 | (v<<16) & 0xff0000 | (v<<8) & 0xff00 | v & 0xff; 
		}
	...
	public static final Parcelable.Creator<GrayscaleJava> CREATOR = new
			  Parcelable.Creator<GrayscaleJava>() {
