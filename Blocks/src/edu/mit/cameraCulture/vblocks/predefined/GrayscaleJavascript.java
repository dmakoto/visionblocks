...
public class GrayscaleJavascript extends Module {
	private static String GRAYSCALE_METHOD =	
...
//		scope.put("image", scope, Context.toObject(image.getImageData(), scope));
...
//		Log.d("Javascript","Finished");
	...
	public static final Parcelable.Creator<GrayscaleJavascript> CREATOR = new
			  Parcelable.Creator<GrayscaleJavascript>() {
