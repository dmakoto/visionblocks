...
public class GrayscaleNative extends Module {
	...
	public static native int ConvertToGrayscale(byte [] byteData, int [] imageData, int width, int height);
	...
	//	ConvertToGrayscale(image.getImageData(), imageData, image.getWidth(), image.getHeight());
	...
	public static final Parcelable.Creator<GrayscaleNative> CREATOR = new
			  Parcelable.Creator<GrayscaleNative>() {
