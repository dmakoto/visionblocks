...
{
	private final String COMPONENT_NAME = "GLSurface";  
    ...
    public void init(int flags, boolean translucent, int depth, int stencil)
    {
        ...
        Log.d(COMPONENT_NAME,"Using OpenGL ES 2.0");
        Log.d(COMPONENT_NAME,"Using " + (translucent ? "translucent" : "opaque") +
        ...
        GLSurfaceView.EGLContextFactory
    {
        ...
        {
            EGLContext context;
            Log.d("GLView.Renderer","Creating OpenGL ES 2.0 context");
    ...
    private static void checkEglError(String prompt, EGL10 egl)
    {
        ...
        {
            Log.d("GLView.Renderer",String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
